...
export const MainHeader = () => {
  ...
  return (
    <header className="accent-black text-blue-500 font-semibold shadow-2xl flex justify-center">
      <div className="mx-auto sm:px-6 lg:px-8 flex justify-between items-center fixed bg-white shadow-2xl rounded-br-full rounded-bl-full gap-60">
        <div className="flex items-center">
          <img src={logo} alt="Company Logo" className="h-12 sm:h-16 lg:h-20" />
        </div>
        <div className="">
        <ul className="flex gap-2 justify-end gap-20">
            <li>HOME</li>
            <li>ABOUT US</li>
            <li>SERVICES</li>
            <li>CONTACT US</li>
