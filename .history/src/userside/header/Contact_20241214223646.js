  ...
  return (
    <div className="container mx-auto px-4">
      ...
      <div className="relative h-64 mb-12">
        <img 
          src="https://as1.ftcdn.net/v2/jpg/05/89/92/50/1000_F_589925063_ecQvtkwNAEnB7Nd9ad3hM7GOP0lae694.jp"
          alt="Contact us"
          ...
          <div className="space-y-6">
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-600">123 Auto Market, Sector 1<br />New Delhi, India 110001</p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-600">info@bidcarsindia.com<br />support@bidcarsindia.com</p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-600">+91 11 2345 6789<br />+91 98765 43210</p>
              </div>
            </div>
          </div>
