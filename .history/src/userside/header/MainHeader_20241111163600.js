...
export const MainHeader = () => {
  ...
  return (
    <header className="accent-black text-blue-500 font-semibold shadow-2xl flex justify-center ">
      <div className="max-w-full top-0 left-0 box-border sm:px-6 lg:px-8 flex justify-between items-center fixed bg-white shadow-2xl rounded-br-3xl rounded-bl-3xl">
          ...
          {user ? (
            ...
            <>
              <NavLink to="/login" className="mr-2">
                <button className="text-white rounded-full font-bold bg-violet-500 hover:bg-violet-600 active:bg-violet-700 focus:outline-none focus:ring focus:ring-violet-300">
                  Login
                </button>
              </NavLink>
              <NavLink to="/signup">
