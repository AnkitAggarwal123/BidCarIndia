...
export const MainHeader = () => {
  ...
  return (
    <header className="accent- text-blue-600 shadow-2xl max-w-full">
      <div className="mx-auto sm:px-6 lg:px-8 flex justify-between items-center fixed bg-white shadow-2xl rounded-3xl">
