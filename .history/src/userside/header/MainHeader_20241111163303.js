...
export const MainHeader = () => {
  ...
  return (
    <header className="accent-black text-blue-500 font-semibold shadow-2xl flex justify-center ">
      <div className="mx-auto max-w-full top-0 left-0 box-border sm:px-6 lg:px-8 flex justify-between items-center fixed bg-white shadow-2xl rounded-br-full rounded-bl-full box-border max-w-full">
