...
export const MainHeader = () => {
  ...
  return (
    <header className="accent- text-blue-600 shadow-2xl">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex justify-between items-center fixed bg-white shadow-2xl rounded-3xl max-w-max">
