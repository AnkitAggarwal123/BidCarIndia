...
export const MainHeader = () => {
  ...
  return (
    <header className="accent-black text-blue-500 font-semibold shadow-2xl">
      <div className="max-w-screen-2xl mx-auto sm:px-6 lg:px-8 flex justify-between items-center fixed bg-white shadow-2xl rounded-br-full rounded-bl-full">
