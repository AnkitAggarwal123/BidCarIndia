      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-wrap justify-between">
          <div className="w-full md:w-1/4 mb-6 md:mb-0">
            <h3 className="text-lg font-bold">Bid Cars India</h3>
            <p>Your Trusted Partner in Salvage Car Auctions. We provide unparalleled service and support in the salvage car industry.</p>
            <p className="text-sm mt-1">We help you dispose of all kinds of salvage (With RC & Without RC) & provide quotes for all kinds of vehicles, including 2 Wheeler, 4 Wheeler, Commercial Vehicles, etc.</p>
            <p>Contact: +91 8882451292</p>
            <p>Email: auction@bidcarsindia.com</p>
          </div>
          <div className="w-full md:w-1/4 mb-6 md:mb-0">
          ...
          <div className="w-full md:w-1/4 mb-6 md:mb-0">
            ...
            <p className="text-sm mt-1"><i className="fas fa-map-marker-alt"></i> West Delhi</p>
            <p className="text-sm mt-1"><i className="fas fa-envelope"></i> auction@bidcarsindia.com</p>
            <p className="text-sm mt-1"><i className="fas fa-phone"></i> +91 8882451292</p>
          </div>
        </div>
      </div>
    </footer>
