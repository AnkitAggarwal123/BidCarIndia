      ...
      <div className="max-w-full mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-wrap justify-between">
          <div className="w-full md:w-1/4 mb-6 md:mb-0">
            <h3 className="text-lg font-bold">Bid Cars India</h3> <br />
            <p>
              Your Trusted Partner in Salvage <br /> Car Auctions. We provide
              unparalleled service <br /> and support in the salvage car industry.
            </p>
            <p className="text-sm mt-1">
