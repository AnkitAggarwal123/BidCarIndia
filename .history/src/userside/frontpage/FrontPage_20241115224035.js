        ...
        {!user && cars.length > 2 && !showAllCars && (
          <div className="text-center mt-6">
            <button
              ...
              className="text-white rounded-full px-4 sm:px-6 py-2 font-bold bg-violet-500 hover:bg-violet-600 active:bg-violet-700 focus:outline-none focus:ring focus:ring-violet-300"
            >
              View All Cars
            </button>
          </div>
