...
const FrontPage = () => {
  ...
  return (
    <div className="font-source-sans-pro bg-white min-h-screen">
      ...
      <div className="bg-black text-white py-16 px-8 flex bg-cover  h-screen bg-no-repeat" style={{backgroundImage: 'url("https://mediapool.bmwgroup.com/cache/P9/202110/P90442352/P90442352-rolls-royce-announces-black-badge-ghost-the-purest-black-badge-yet-600px.jpg")',}}>
