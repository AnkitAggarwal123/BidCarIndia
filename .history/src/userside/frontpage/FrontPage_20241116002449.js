...
const FrontPage = () => {
  ...
  return (
    <div className="font-source-sans-pro bg-white min-h-screen">
      ...
      <div className="bg-black text-white py-16 px-8 flex">
        <div className="max-w-7xl mx-auto ">
          ...
          <p className="mt-6 font-bold text-gray-300 max-w-3xl mx-auto leading-tight">
          At Bids Car India, we are revolutionizing the automobile auction industry, offering a dynamic platform where buyers and sellers connect seamlessly for exceptional deals on vehicles. With a steadfast commitment to transparency, innovation, and customer satisfaction, we empower individuals and businesses to bid with confidence. Our passion lies in creating a fair and competitive marketplace that bridges the gap between vehicle owners and aspiring buyers. At Bids Car India, we are your trusted partner, redefining the future of automobile auctions with integrity and excellence.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 max-w-5xl mx-auto">
          {[
            ...
            { src: "https://stimg.cardekho.com/images/carexteriorimages/930x620/Maruti/Ertiga/10293/1687252933647/rear-left-view-121.jpg", name: "Ertiga" },
            { src: "https://imgd.aeplcdn.com/664x374/n/cw/ec/44709/fortuner-exterior-right-front-three-quarter-20.jpeg?isig=0&q=80", name: "SUV" },
            { src: "https://akm-img-a-in.tosshub.com/indiatoday/images/story/202408/mahindra-thar-roxx-200912599-16x9_0.jpg?VersionId=8gFUdclSl6.epCT95iSrtU5MCXzyDyRR&size=690:388", name: "Thar" },
            { src: "https://static1.topspeedimages.com/wordpress/wp-content/uploads/2023/01/mercedes-g-wagen.jpg?q=70&fit=crop&w=1140&h=&dpr=1", name: "G-Wagon" },
            { src: "https://cdn.motor1.com/images/mgl/zxVvnK/s1/mercedes-amg-cle-53-cabriolet-2024.webp", name: "Cabriolet" },
          ].map((car, index) => (
            <div
              key={index}
              className="relative group bg-white text-center rounded-lg shadow-lg overflow-hidden"
            >
              <img
                src={car.src}
                alt={car.name}
