  ...
  return (
    <div className="font-source-sans-pro bg-white min-h-screen">
      ...
      >
        ...
        <div className="flex flex-col justify-center items-center text-black h-full mt-11">
          <h2 className="text-6xl font-bold">Welcome to Bid Cars India</h2>
          <p className="text-xl">Bid With Us, Grow With Us</p>
        </div>
      </section>
      <div className="bg-black text-white py-16 px-8 flex bg-cover bg-center bg-no-repeat" style={{backgroundImage: 'url("https://wallpapercat.com/w/full/5/b/6/1756484-2560x1600-desktop-hd-rolls-royce-cullinan-wallpaper-photo.jpg")',}}>
