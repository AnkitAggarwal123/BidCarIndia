...
const FrontPage = () => {
  ...
  return (
    <div className="font-source-sans-pro bg-white min-h-screen">
      ...
      <div className="bg-black text-white py-16 px-8 flex bg-cover bg-center bg-no-repeat pt20" style={{backgroundImage: 'url("https://wallpapercat.com/w/full/5/b/6/1756484-2560x1600-desktop-hd-rolls-royce-cullinan-wallpaper-photo.jpg")',}}>
