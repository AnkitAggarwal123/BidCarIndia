  ...
  return (
    <div className="font-source-sans-pro bg-white min-h-screen">
      ...
      >
        ...
        <div className="flex flex-col justify-center items-center text-black h-full bg-cover" style={{backgroundImage: 'url("https://mediapool.bmwgroup.com/cache/P9/202110/P90442352/P90442352-rolls-royce-announces-black-badge-ghost-the-purest-black-badge-yet-600px.jpg")',}}>
